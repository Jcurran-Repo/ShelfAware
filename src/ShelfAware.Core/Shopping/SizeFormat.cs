...
/// Receipts disagree on casing and spacing, but the predictor already groups sizes case-insensitively
/// (its SizeKey lowercases and trims), so this is purely cosmetic — it never changes which purchases roll
