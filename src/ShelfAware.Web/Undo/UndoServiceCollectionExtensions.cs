...
public static class UndoServiceCollectionExtensions
{
    ...
    public static void AddHandlers(IServiceCollection services)
    {
        ...
        services.AddScoped<IUndoHandler, SubstituteRemovedHandler>();
        services.AddScoped<IUndoHandler, GroceryExtrasAddedHandler>();
        services.AddScoped<IUndoHandler, GroceryExtraRemovedHandler>();
        ...
        services.AddScoped<IUndoHandler, ProductsMergedHandler>();   // reversible (manifest-backed un-merge)
